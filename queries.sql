...
AND agronomist_id IN
	...
	(SELECT degustation_id FROM degustation_customer WHERE customer_id = 5)
...
WHERE Degustation_Customer.customer_id = 1 AND Degustation.agronomist_id = 1
AND Degustation.degustation_date BETWEEN '2010-01-01' AND '2021-01-01';
...
AND agronomist_id = 1 GROUP BY Degustation.degustation_id) h WHERE h.num > 1) GROUP BY product_id;
...
FROM Order_Return WHERE return_date BETWEEN '2010-01-01' AND '2021-01-01'
