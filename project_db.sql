...
CREATE INDEX idx_agronom_id ON agronomist (agronomist_id);

CREATE INDEX idx_customer_name ON customer (customer_name);
CREATE INDEX idx_customer_id ON customer (customer_id);

CREATE INDEX idx_product_id ON ordering (product_id);
CREATE INDEX idx_order_id ON ordering (order_id);

-- Multiple index on product_ids
CREATE INDEX idx_product_agronomist_id ON ordering (product_id, agronomist_id);
CREATE INDEX idx_product_customer_id ON ordering (product_id, customer_id);
